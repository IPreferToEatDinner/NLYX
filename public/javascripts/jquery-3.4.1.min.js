...
!(function (e, t) {
  ...
  function (C, e) {
    ...
    (me = E.createDocumentFragment().appendChild(
      ...
      (xe = E.createElement('input')).setAttribute(
        'type',
        'radio'
      ),
      ...
      (y.noCloneChecked = !!me.cloneNode(!0).lastChild
        .defaultValue);
    var Te = /^key/,
    ...
    function Ie(n, r, i, o) {
      ...
      if (
        f &&
        ((t = (e = we(r, n[0].ownerDocument, !1, n, o))
          .firstChild),
        1 === e.childNodes.length && (e = t),
        t || o)
      ) {
        for (
          s = (a = k.map(ve(e, 'script'), Pe)).length;
          c < f;
          c++
        )
          (u = e),
      ...
      k.fn.extend({
        ...
        position: function () {
          if (this[0]) {
            ...
            return {
              top:
                t.top - i.top - k.css(r, 'marginTop', !0),
              left:
                t.left -
                i.left -
